...
type Request struct {
	...
	DeliveryDate       uint32             `protobuf:"varint,5,opt,name=deliveryDate,proto3" json:"deliveryDate,omitempty"`
...
func (x *Request) GetDeliveryDate() uint32 {
	if x != nil {
		return x.DeliveryDate
	}
	return 0
...
var file_igo_v1_igo_proto_rawDesc = []byte{
	...
	0x79, 0x44, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x64, 0x65, 0x6c,
